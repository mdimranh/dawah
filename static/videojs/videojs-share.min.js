...
!(function (t, e) {
  ...
  function f() {
    ...
    var o = d({ app_id: e, display: "popup", redirect_uri: i, link: n });
    return window.open(
      "https://www.facebook.com/dialog/feed?" + o,
      "_blank",
      tt
    );
  }
  function p() {
    ...
    return window.open(
      "https://www.facebook.com/dialog/share?" + r,
      "_blank",
      tt
    );
  }
  function v() {
    ...
    return window.open(
      "https://www.facebook.com/sharer/sharer.php?" + e,
      "_blank",
      tt
    );
  }
  ...
  function y() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      e = d({ "st.cmd": "addShare", "st._surl": t.url, title: t.title });
    return window.open("https://ok.ru/dk?" + e, "_blank", tt);
  }
  function b() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      e = d({ url: t.url, text: t.title });
  ...
  function k() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      n = t.url,
      i = t.hashtags,
      o = d({ text: e, url: n, hashtags: (void 0 === i ? [] : i).join(",") });
    return window.open("https://twitter.com/intent/tweet?" + o, "_blank", tt);
  }
  function _() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      e = d({ url: t.url, title: t.title });
    return window.open("https://www.reddit.com/submit?" + e, "_blank", tt);
  }
  function C() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      e = t.description,
      n = d({ url: t.url, description: e, media: t.media });
    return window.open(
      "https://pinterest.com/pin/create/button/?" + n,
      "_blank",
      tt
    );
  }
  function x() {
    ...
    return window.open(
      "https://www.tumblr.com/widgets/share/tool?" + s,
      "_blank",
      tt
    );
  }
  ...
  function F() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      o = t.description,
      r = t.title;
    o && o.length > et && (o = o.substr(0, et) + "..."),
      r && r.length > et && (r = r.substr(0, et) + "...");
    return (
      "https://vk.com/share.php?" +
      d(
        i
          ? { url: e }
          : { url: e, title: r, description: o, image: n, noparse: !0 }
      )
    );
  }
  function A() {
  ...
  function z() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      e = t.title,
      n = t.url,
      i = d({ title: e, summary: t.description, url: n });
    return window.open(
      "https://www.linkedin.com/shareArticle?mini=true&" + i,
      "_blank",
      tt
    );
  }
  ...
  function O() {
    ...
    return (
      ...
      window.open("https://line.me/R/msg/text/?" + i, "_blank", tt)
    );
  }
  function L() {
    return (
  ...
  var I = (function () {
    ...
    q = (function (t) {
      function e(n, i) {
        ...
        return (
          o.addClass("vjs-menu-button"),
          o.addClass("vjs-share-control"),
          o.addClass("vjs-icon-share"),
          o.controlText(n.localize("Share")),
          o
        );
      }
      return (
  ...
  var K = o,
    ...
    rt = (function () {
      function t(e, n) {
        R(this, t),
          (this.player = e),
          (this.options = n),
          (this.socials = H(n.socials, n.mobileVerification)),
      ...
      return (
        ...
        (t.prototype._createContent = function () {
          var t =
              ...
              this.copyBtnTextClass +
              '">' +
              this.player.localize("Copy") +
              "</span>\n    ",
            e = document.createElement("div"),
            n = "";
          this.options.embedCode &&
            (n =
              '\n        <div class="vjs-share__subtitle hidden-xs">' +
              this.player.localize("Embed Code") +
              ':</div>\n        <div class="vjs-share__short-link-wrapper hidden-xs">\n          <input class="vjs-share__short-link" type="text" readonly="true" value="' +
              this.options.embedCode +
              '">\n          <div class="vjs-share__btn">\n            ' +
              t +
              "\n          </div>\n        </div>"),
            (e.innerHTML =
              '<div class="vjs-share">\n      <div class="vjs-share__top hidden-sm">\n        <div class="vjs-share__title">' +
        ...
        (t.prototype._initClipboard = function () {
          ...
          new $(".vjs-share__btn", {
            ...
            (n.innerText = t.player.localize("Copied")),
              L()
                ? setTimeout(i, 1e3)
                : n.parentElement.addEventListener("mouseleave", function () {
                    setTimeout(i, 300);
                  });
          });
        }),
        ...
        (t.prototype._initToggle = function () {
          ...
          (window.innerWidth <= 180 && this.socials.length > 6)
            ? (t.style.height = "calc((2em + 5px) * 2)")
            : t.classList.add("horizontal");
        }),
        (t.prototype._getSocialItems = function () {
          var t = [];
          return (
            this.socials.forEach(function (e) {
              ot[e] &&
                t.push(
                  '\n          <button class="vjs-share__social vjs-share__social_' +
                    e +
                    '" data-social="' +
                    e +
                    '">\n            ' +
    ...
    at = (function (t) {
      ...
      return (
        ...
        (e.prototype.open = function () {
          var e = this.player();
          e.addClass(this.playerClassName),
            t.prototype.open.call(this),
            e.trigger("sharing:opened");
        }),
        (e.prototype.close = function () {
          var e = this.player();
          e.removeClass(this.playerClassName),
            t.prototype.close.call(this),
            e.trigger("sharing:closed");
        }),
        e
      );
    ...
    lt = (function (t) {
      ...
      return (
        N(e, t),
        (e.prototype._createModal = function () {
          var t = new rt(this.player, this.options).getContent();
          (this.modal = new at(this.player, { content: t, temporary: !0 })),
    ...
    st = (function (e) {
      function n(i, o) {
        ...
        return (
          (r.options = t.mergeOptions(P, o)),
          r.player.ready(function () {
            r.player.addClass("vjs-share"),
              i.addClass("vjs-videojs-share"),
              i.getChild("controlBar").addChild("ShareButton", o),
              i.addChild("ShareOverlay", o);
          }),
          r
        );
      }
  ...
  return (
    (st.defaultState = {}),
    (st.VERSION = "3.2.1"),
    t.registerComponent("ShareButton", q),
    t.registerComponent("ShareOverlay", lt),
    t.registerPlugin("share", st),
    st
  );
});
