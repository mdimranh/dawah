...
window.jwplayer = (function (t) {
  ...
  function (t, e, n) {
    ...
    var i = function () {
      ...
      g = function () {
        return (
          (r(/safari/i) && !r(/(?:Chrome|CriOS|chromium|android|phantom)/i)) ||
          d()
        );
      },
      m = function () {
  ...
  function (t, e, n) {
    ...
    var r =
      "8.21.2+commercial_v8-21-2.469.commercial.835873b.hlsjs..hlsjsalt..jwplayer.ca08ad9.dai.1f98a0b.freewheel.1f60863.googima.1281534.googimanvmp.106f6b4.headerbidding.bae6b39.vast.5594430.analytics.920ae01.gapro.141397a";
  },
  function (t, e, n) {
    "use strict";
    var r = n(0),
    ...
    function m(t, e) {
      var n = "file:" === window.location.protocol ? "https:" : "",
        r = {
          ...
          googima: e
            ? "//ssl.p.jwpcdn.com/player/v/8.21.2/googimanvmp.js"
            : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.9.0/googima.js",
          freewheel:
            "//ssl.p.jwpcdn.com/player/plugins/freewheel/v/2.2.13/freewheel.js",
          ...
          Object(r.x)(i) &&
            ...
            ((j.playlist = (function (t, e) {
              var n = (t.querySelector("title") || {}).textContent,
                ...
                o =
                  f(t, 'meta[property="og:description"]') ||
                  f(t, 'meta[name="description"]');
              return (
            ...
            var e = t.get("controls"),
              ...
              i = (function (t, e) {
                ...
                if (Array.isArray(n) && n.length)
                  for (
                    var r = Object(O.f)(t.get("item"), n.length),
                      i = Object(O.c)(Object(w.a)(n[r]), t),
                      o = 0;
                    o < i.length;
                    o++
                  )
                    for (
                      var u = i[o], a = t.getProviders(), c = 0;
                      c < k.a.length;
                      c++
                    ) {
                      var s = k.a[c];
          ...
          (e.getAllItems = function () {
            ...
            return this.items.reduce(function (e, n) {
              ...
              return (
                r &&
                  (e[n] =
                    "captions" !== n ? Object(K.serialize)(r) : JSON.parse(r)),
                e
              );
            }, {});
          }),
    ...
    Object(r.j)(ct.prototype, {
      ...
      init: function (t, e) {
        ...
        i.get("backgroundLoading") ||
          (s = Object(ut.a)(s.getPrimedElement(), s));
        var l = (this.primeUi = new at.a(
          Object(at.b)(this.originalContainer)
                    ...
                    if (!o) {
                      ...
                      it.a.cloneIcon &&
                        u
                          ...
                          .appendChild(it.a.cloneIcon("error")),
                        ft(t, u);
                    }
                    i.set("errorEvent", r),
                      i.set("state", I.lb),
...
var jwDefaults = {
  ...
  floating: {},
  height: 270,
  key: "yzilba2QAlFfNhO/8kCtQiNPzFZgoC2q/BYR9U91ad6TfUh6jpNpdeqrytzeZRVC",
  mute: false,
  ph: 1,
  pid: "2dUa3fLF",
  ...
  related: {
    autoplaytimer: 10,
    file: "//cdn.jwplayer.com/v2/playlists/xesasvok?related_media_id=MEDIAID",
    onclick: "play",
    oncomplete: "autoplay",
  },
  repeat: true,
  sharing: {
    code: "%3Ciframe%20src%3D%22//content.jwplatform.com/players/MEDIAID-2dUa3fLF.html%22%20width%3D%22480%22%20height%3D%22270%22%20frameborder%3D%220%22%20scrolling%3D%22auto%22%3E%3C/iframe%3E",
    sites: ["facebook", "email", "twitter"],
  },
  skin: {
    controlbar: {
